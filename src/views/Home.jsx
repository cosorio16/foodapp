...
function Home() {
  ...
  return (
    <div>
      ...
      <Modal />
      <div className="py-5 px-3 md:px-4 xl:px-16 items-center justify-items-center grid gap-5 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 font-Poppins bg-neutral-50 min-h-dvh">
        {products.length > 0 ? (
